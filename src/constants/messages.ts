...
export const messages = {
  ...
  sdkAlreadyInitialized: 'IBM Aspera Browser SDK has already been initialized',
  serverError: 'Unable to connect to IBM Aspera for Desktop server',
  serverNotVerified: 'IBM Aspera Browser SDK has not been verified. Run test or init first',
