...
function createConnectMock(): any {
  ...
  return {
    ...
    showAbout: jest.fn().mockImplementation((...args) => {
      capture('showAbout')(...args);
      return Promise.resolve({});
    }),
    ...
    showPreferencesPage: jest.fn().mockImplementation((...args) => {
      capture('showPreferencesPage')(...args);
      return Promise.resolve({});
    }),
    showTransferMonitor: jest.fn().mockImplementation((...args) => {
